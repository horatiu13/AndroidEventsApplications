...
!!! In fisierul changelog.txt voi trece ce am modificat la fiecare comit (nu o sa fie pe versiuni, cum e normal, o sa fie pe data:ora commit-ului). 
!!! In fisier vor scrie mai detaliat ce s-a modificat decat in numele commitului (am observat ca versiunea de SourceTree pe care o folosesc nu se prea descurca cu comment-uri foarte lungi)
